...
def main():
    ...
    outs = ["low pressure system located wested of ireland, moving northeast and deepening. high pressure area positioned over central europe, near germany and poland, moving east. low pressure system situated south of italy, stationary in the tyrrhenian sea."] #  actual generation
    srcs = ["low, ireland, high, scandinavia, 1035, greenland"] # inputs to the model (not sure what we will input here yet...?)
